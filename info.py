...
OWNER_ID = environ.get('OWNER_ID', '5860332990')
...
CHAT_GROUP = int(environ.get("CHAT_GROUP", "-1001803321114"))

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6497757690 5860332990').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001959367903') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001959367903') # request channel id ( make sure bot is admin )
...
AI_LOGS = int(environ.get("AI_LOGS", "-1002385478610")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of Bot ]

#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '').split()]
TEXT = environ.get("APPROVED_WELCOME_TEXT", "<b>{mention},\n\nʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ {title} ɪs ᴀᴘᴘʀᴏᴠᴇᴅ.\n\‣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ @SihagBots</b>")
APPROVED = environ.get("APPROVED_WELCOME", "on").lower()

# Referal Settings
REFERAL_COUNT = int(environ.get('REFERAL_COUNT', '20')) # number of referal count
REFERAL_PREMEIUM_TIME = environ.get('REFERAL_PREMEIUM_TIME', '1 week')
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'vbkguru') # owner username without @

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002386658352')) #Log channel id ( make sure bot is admin )
DUMP_CHNL = int(environ.get('DUMP_CHNL', '-1002421441796'))
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/vbkboss')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+o8hZ6VXUpuo2MDZl') #Support group link ( make sure bot is admin )
